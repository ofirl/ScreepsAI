...
const MINER_DEATH_SPAWN_TICKS = 15;

const SOLDIER_MIN_TICKS_TO_ATTACK = 1450;
const SOLDIER_FLEE_HP = 0.5;
...
module.exports = {
    ...
    SOLDIER_FLEE_HP : SOLDIER_FLEE_HP,
    SOLDIER_MIN_TICKS_TO_ATTACK : SOLDIER_MIN_TICKS_TO_ATTACK,
};
